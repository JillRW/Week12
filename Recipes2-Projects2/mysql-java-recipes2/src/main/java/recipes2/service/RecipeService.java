...
import recipes2.dao.Recipe2Dao;
...
public class RecipeService {
	private static final String SCHEMA_FILE = "recipe2_schema.sql";
	private static final String DATA_FILE = "recipe_data.sql";

	private Recipe2Dao recipeDao = new Recipe2Dao();
